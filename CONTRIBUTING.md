# Go Insert Locale plugin contributions
...
[code of conduct](https://github.com/AlejandroSuero/go-insert-locale/blob/main/CODE_OF_CONDUCT.md#contributor-covenant-code-of-conduct)**.

## Dependencies

This project uses [gofmt](https://pkg.go.dev/cmd/gofmt) as the formatter.
...
1. **Configure the development**
   ...
   - **Clone your fork**: After the fork, make a clone of your repo `username/go-insert-locale`
...
2. **Work on your changes**
   ...
   > You can use `make format` to check if your changes are correct.
...
- **Follow the code style**: Try to match the code style as much as possible. Follow
  ...
  for `go` files, [gofmt](https://pkg.go.dev/cmd/gofmt).
